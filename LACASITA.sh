 ...
 echo -e " \e[97m\033[1;41m   =====>>►►  SCRIPT MOD DARK  ◄◄<<=====      \033[1;37m\033[0m" 
 ...
 msg -ama "     [ SCRIPT \033[1;97m MOD DARK\033[1;33m ]" 
...
# && sudo dpkg-reconfigure locales 
 ...
 permited=$(curl -sSL "https://www.dropbox.com/s/vsy1sacipccypeh/control") 
 ...
 *)ARQ="${SCPfrm}/";; #Herramientas 
 ...
 msg -ama " Notify-BOT (Notificasion Remota)|@DARK_MOD_Noty_Bot " 
 ...
 echo -e "\033[1;92m ¡¡ Para sacar su ID entre al BOT @CAT" 
 ...
 msg -bar2 && msg -ne "\033[1;93m          >>> INGRESE SU KEY ABAJO DARK <<<\n   \033[1;37m" && read Key 

 tput cuu1 && tput dl1 

 done 

 msg -ne "    # Verificando Key Dark # : " 
